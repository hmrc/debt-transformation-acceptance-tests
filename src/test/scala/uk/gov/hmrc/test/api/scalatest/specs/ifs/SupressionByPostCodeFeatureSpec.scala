...
class SupressionByPostCodeFeatureSpec
  ...
  Feature("Suppression by Postcode") {
    ...
    ignore("Suppression applied to customers latest postcode - 2 postcodes one before interest start date") { context =>
    ...
    ignore("Suppression not applied to customers previous postcode", WIP, DTD_400) { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression applied to customers latest postcode - 2 postcodes") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression Start Date for a Postcode before interest start date") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression should not be applied where postcode date after suppression period - border case") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression should be applied if customer moved in on last day of suppression period - border case") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression should be applied to customer sub district [subDistrict=AA9A, postCode=AA9A 9AA]") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression should be applied to customer sub district [subDistrict=A99, postCode=A99 9AA]") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression should be applied to customer sub district [subDistrict=AA9, postCode=AA9 9AA]") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression should be applied to customer sub district [subDistrict=AA99, postCode=AA99 9AA]") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
    ...
    ignore("Suppression should not be applied for non matching postcodes") { context =>
      Given("suppression configuration data is created")
      // TODO: No matching helper method found for this step. Validate and call the correct helper.
      // TODO: This step had a feature table; convert the values into typed builder/model inputs.
