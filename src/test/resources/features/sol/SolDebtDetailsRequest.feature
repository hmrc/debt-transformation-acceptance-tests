Feature: statement of liability Debt details
  ...
  Scenario: 3. Non interest bearing with payment history and no breathing space.
    Given debt details
      | solType | debtId  | mainTrans | subTrans | interestRequestedTo |
  ...
  Scenario: 4. Large interest bearing debt with breathing space and no payment history - 9999999999.
    Given debt details
      | solType | debtId  | mainTrans | subTrans | interestRequestedTo |
  ...
  Scenario: 5. Interest bearing debts - 2 duties each with payment history and breathing space
    Given debt details
      | solType | debtId   | mainTrans | subTrans | interestRequestedTo |
